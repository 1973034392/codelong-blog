...
<head>
    ...
    <style>
        ...
        .markdown-body pre { background: var(--bg-color2) !important; border-radius: 8px; }
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const katexExtension = window.markedKatex;
        ...
        renderer.code = (code, lang) => {
            ...
            const highlightedCode = hljs.highlight(codeString, { language, ignoreIllegals: true }).value;
